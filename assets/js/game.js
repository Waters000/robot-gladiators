...
// if player is not alive, break ouf the loop and let endGame function run
  else {
    window.alert('You have lost your robot in battle! Game Over!');
    break;
  }
}
// after loop ends, we are either out of playerhealth or enemies to fight,
endGame();
    };
