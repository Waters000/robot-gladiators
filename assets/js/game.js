...
var fight = function(enemy) {
    ...
    while (playerInfo.health > 0 && enemy.health > 0) {
      if (isPlayerTurn) {
        ...
        // random number from object PlayerInfoAttack min and max
        var damage = randomNumber(playerInfo.attack - 3, playerInfo.attack);
  
        // new variable remove enemy's health by subtracting the amount we set in the damage variable
  ...
  var startGame = function() {
    // reset player stats with function object within object
    playerInfo.reset();
  
    // fight each enemy robot with for loop, looping over them and fighting them one at a time
    for (var i = 0; i < enemyInfo.length; i++) {
      ...
      if (playerInfo.health > 0) {
        ...
        // set health for looped enemy robot from array object and give random health for picked enemy
...
var endGame = function() {
  ...
  // check localStorage for high score, it it's not there us a 0
